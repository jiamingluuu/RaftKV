...
public:
    ...
    // Notifies the Node that the application has saved progress up to the last
    // ready. It prepares the node to return the next available ready.
    //
    ...
    // Reports the status of the sent snapshot. The id is the raft ID of the
    // follower who is meant to receive the snapshot, and the status is
    // SnapshotFinish or SnapshotFailure.
